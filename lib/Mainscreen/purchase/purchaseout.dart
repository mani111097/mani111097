...
class PurchaseOut extends StatefulWidget {
  const PurchaseOut({Key? key}) : super(key: key);

  @override
  State<PurchaseOut> createState() => _PurchaseOutState();
}

class _PurchaseOutState extends State<PurchaseOut> {
  @override
